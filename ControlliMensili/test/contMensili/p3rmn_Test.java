...
public class p3rmn_Test {
	...
	public final void testUiPercCalculation() {
		...
		double result = p3rmn_.uiPercCalculation(max, min);
	...
	public final void testGhostPercCalculation() {
		...
		double result = p3rmn_.ghostPercCalculation(mediaGhost, meanBkg,
				meanImage);
		assertEquals(expected, result, 1e-12);
	}
	...
	public final void testMainUnifor() {
		...
		boolean test = true;
		p3rmn_.prepUnifor(path1, path2, autoArgs, autoCalled, step, verbose,
				test);
	...
	public final void testMixUniforTestSiemens() {
		String path1 = ".\\Test2\\HUSA_001testP3";
		String path2 = ".\\Test2\\HUSA_002testP3";
		double[] vetReference = new p3rmn_().referenceSiemens();
		String autoArgs = "0";
		boolean autoCalled = false;
		boolean step = false;
		boolean verbose = true;
		...
		ResultsTable rt1 = p3rmn_.mainUnifor(path1, path2, roiData, autoArgs,
	...
	public final void testMixUniforTestGe() {
		...
		double[] vetReference = new p3rmn_().referenceGe();
		String autoArgs = "0";
		boolean autoCalled = false;
		boolean step = false;
		boolean verbose = true;
		boolean test = true;
		UtilAyv.setMeasure(MyConst.HMEAN + MyConst.HSTD_DEV);
		int[] roiData = { MyConst.P3_X_ROI_TESTGE, MyConst.P3_Y_ROI_TESTGE,
				MyConst.P3_DIAM_PHANTOM };
		ResultsTable rt1 = p3rmn_.mainUnifor(path1, path2, roiData, autoArgs,
				autoCalled, step, verbose, test);
		double[] vetResults = UtilAyv.vectorizeResults(rt1);
		boolean ok = UtilAyv.verifyResults1(vetResults, vetReference,
