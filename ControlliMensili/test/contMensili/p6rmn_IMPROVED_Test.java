...
public class p6rmn_IMPROVED_Test {
...
//		String[] pathSortato = new p16rmn_().bubbleSortPath(path, position);
...
//		int d2y = 67;
//		Line.setWidth(11);
//		double[] profiM1 = new p16rmn_().getLinePixels(imp1, c2x, c2y, d2x, d2y);
...
////		imp3 = null;
////		double[] dsd1 = new p16rmn_().analProf(imp3, vetTestPositions,
...
//		double[] profiB1 = new p16rmn_().baselineCorrection(profiM1, media1,
//				media2);
//		double[] expectedOutput = InputOutput
...
//		// test con input numerico, non dipendente da ImageJ
//		boolean invert = true;
//		double[] profiE1 = new p16rmn_().createErf(profiB1, invert);
...
//		int isd3[] = new p16rmn_().analPlot1(profile1, bSlab);
...
//
	...
	public final void testSpessStrato() {
		...
		double[] result = p6rmn_IMPROVED.spessStrato_CORRETTO_OLD(R1, R2, sTeor, dimPix2);
	...
	@Test
	public final void testSpessStrato_due_1() {
		...
		MyLog.logVector(result, "result_IMPROVED");
		MyLog.waitHere();

	}
	
	@Test
	public final void testSpessStrato_cinque_1() {

		double R1 = 34.551487718;
		double R2 = 31.818490699;
		double sTeor = 5.0;
		double dimPix2 = 0.78125;
		double[] result = p6rmn_IMPROVED.spessStrato_CORRETTO_OLD(R1, R2, sTeor, dimPix2);
...
//		vetline[3] = yEnd;
//		int matrix = 512;
//		boolean flag = new p16rmn_().interdiction(vetline, matrix);
//		assertFalse(flag);
//	}
//
//	@Test
...
//		String[] path = null;
//
//		ImagePlus newStack = new p16rmn_().stackBuilder(path, false);
//
//		assertNull(newStack);
//	}
//
...
//				MyConst.TEST_FILE, list, MyConst.TEST_DIRECTORY);
//		ImagePlus newStack = new p16rmn_().stackBuilder(path, true);
...
//		boolean bFw = true;
//		new p16rmn_().createPlot2(profile1, bslab, bLabelSx, sTitolo, bFw);
...
//		boolean test = true;
//
//		ResultsTable rt = new p16rmn_().mainThickness(path1, autoArgs,
...
//				new p16rmn_().referenceSiemens(), MyConst.P6_vetName);
//		assertTrue(ok);
//	}
//
//	@Test
...
//		double[] vetResults = UtilAyv.vectorizeResults(rt);
//		boolean ok = UtilAyv.verifyResults1(vetResults,
//				new p16rmn_().referenceGe(), MyConst.P6_vetName);
//		assertTrue(ok);
//	}
//
//	@Test
//	public final void testTestSilent() {
//		new p16rmn_().selfTestSilent();
//	}
//
//	@Test
...
//		boolean test = true;
//
//		ResultsTable rt = new p16rmn_().mainThickness(path, autoArgs,
//				vetRefPosition, autoCalled, step, verbose, test);
//
//		double[] vetResults = UtilAyv.vectorizeResults(rt);
//		boolean ok = UtilAyv.verifyResults1(vetResults,
