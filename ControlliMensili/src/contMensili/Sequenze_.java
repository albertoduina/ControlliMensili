...
public class Sequenze_ implements PlugIn {
	 ...
	 * conto dei controlli gi� effettuati, per cui si pu� spegnere il PC e
			...
			if (TableSequence.getDone(tableSequenze5, j1).equals("0")) {
				...
				if (superficiali) {
					if ((plugin.equals("contMensili.p10rmn_")) || (plugin.equals("contMensili.p11rmn_"))
							|| (plugin.equals("contMensili.p12rmn_")) || (plugin.equals("contMensili.p5rmn_"))
	 ...
	 * come argomento al plugin. Potremo avere ad esempio 12#13#14#15 , se �
	 ...
	 * ci� non accade viene passata una tabella di warnings a
	 * logVerifySequenceTable. Si pu� comunque continuare a lavorare
	 * 
	...
	/**
	 * Verifica che il numero di immagini rilevate da scanlist per un certo tipo
	 * di codice immagine corrisponda al numero previsto in iw2ayv.txt. Se ci�
