...
public class p13rmn_ implements PlugIn, Measurements {
	...
	public static String VERSION = "UNIFORMITA' SNR GHOSTS per bobine quadrate manuale";

	private static String TYPE = " >> CONTROLLO UNIFORMITA'QUADRATO";
...
//		VERSION = className + "_build_" + MyVersion.getVersion() + "_iw2ayv_build_" + MyVersionUtils.getVersion();
	...
	public int autoMenu(String autoArgs) {
		...
		if (nTokens == MyConst.TOKENS2) {
			...
			MyLog.logDebug(vetRiga[0], "P13", fileDir);
			MyLog.logDebug(vetRiga[1], "P13", fileDir);
			...
			MyLog.logDebug(vetRiga[0], "P13", fileDir);
			MyLog.logDebug(vetRiga[2], "P13", fileDir);
		}
	...
	public static void writeStoredRoiData(Rectangle boundingRectangle) {
		...
		Prefs.set("prefer.p13rmnLatoRoi", Integer.toString(boundingRectangle.width));
		Prefs.set("prefer.p13rmnXRoi1", Integer.toString(boundingRectangle.x));
		Prefs.set("prefer.p13rmnYRoi1", Integer.toString(boundingRectangle.y));
	}
